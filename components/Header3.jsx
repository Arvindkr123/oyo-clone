    ...
    <div className="bg-gradient-to-r from-red-600 to-red-400 h-60">
      <div className="p-5">
        <h2 className="text-white font-bold text-4xl text-center">
          Over 157,0000 hotels and homes across 35 countries
        </h2>
        ...
        <div className="flex mx-20 my-5">
          <button
            type="submit"
            className="h-16 font-bold px-3 py-2 hover:cursor-pointer text-white  mr-5"
          >
            Continue your search
          </button>
          <button
            type="submit"
            className="h-16 font-bold border-2 border-white px-3 py-2 hover:cursor-pointer text-white  mr-5 hover:bg-gray-500 rounded-xl"
          >
